...
const char cmd_string_so2_sen[] PROGMEM     = "no2_sen    ";
const char cmd_string_so2_slope[] PROGMEM   = "no2_slope  ";
const char cmd_string_so2_off[] PROGMEM     = "no2_off    ";
const char cmd_string_o3_sen[] PROGMEM      = "co_sen     ";
const char cmd_string_o3_slope[] PROGMEM    = "co_slope   ";
const char cmd_string_o3_off[] PROGMEM      = "co_off     ";
...
void restore(char * arg) {
  ...
  if (strncmp(arg, "defaults", 8) == 0) {
    ...
    eeprom_write_block("aqev2_so2_o3_esp", (void *) EEPROM_UPDATE_FILENAME, 32);
  }  
  else if (strncmp("key", arg, 3) == 0) {
