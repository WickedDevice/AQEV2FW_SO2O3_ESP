...
#define EEPROM_O3_ZERO_NEGATIVE_RESULTS (EEPROM_SO2_ZERO_NEGATIVE_RESULTS - 1)
//  /\
...
boolean publishHeartbeat(){
  ...
  "\"converted-value\":%d,"
  "\"firmware-version\":\"%s\","
  "\"publishes\":[\"so2\",\"o3\",\"temperature\",\"humidity\"%s],"
  "\"counter\":%lu"
